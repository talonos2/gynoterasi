...
{
    /*
    public class CompProperties_AbilityFireBreath : CompProperties_AbilityEffect
    {
        public float range;

        public float lineWidthEnd;

        public EffecterDef casterVisualEffect;

        public CompProperties_AbilityFireBreath()
        {
            compClass = typeof(CompAbilityEffect_FireBreath);
        }
    }

    public class CompAbilityEffect_FireBreath : CompAbilityEffect
    {
        private List<IntVec3> tmpCells = new List<IntVec3>();

        private new CompProperties_AbilityFireBreath Props => (CompProperties_AbilityFireBreath)props;
        ...
        public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
        {
            ...
            GenExplosion.DoExplosion(affectedAngle: new FloatRange(num - 28.5f, num + 28.5f), center: position, map: parent.pawn.MapHeld, radius: Props.range, damType: DamageDefOf.Flame, instigator: Pawn, damAmount: -1, armorPenetration: -1f, explosionSound: null, weapon: null, projectile: null, intendedTarget: null, postExplosionSpawnThingDef: null, postExplosionSpawnChance: 1f, postExplosionSpawnThingCount: 1, postExplosionGasType: null, applyDamageToExplosionCellsNeighbors: false, preExplosionSpawnThingDef: null, preExplosionSpawnChance: 0f, preExplosionSpawnThingCount: 1, chanceToStartFire: 1f, damageFalloff: false, direction: null, ignoredThings: null, doVisualEffects: false, propagationSpeed: 0.6f, excludeRadius: 0f, doSoundEffects: false);
        ...
        public override IEnumerable<PreCastAction> GetPreCastActions()
        {
            yield return new PreCastAction
            {
                ...
                {
                    parent.AddEffecterToMaintain(Props.casterVisualEffect.Spawn(parent.pawn.Position, a.Cell, parent.pawn.Map), Pawn.Position, a.Cell, 17, Pawn.MapHeld);
                },
